...
class Request {
  ...
  /// 直接下载文件，不经过 Clash 代理（用于首次获取订阅等场景）
  Future<Response<Uint8List>> getFileResponseForUrlDirect(String url) async {
    try {
      final ua = appController.isAttach
          ? appController.ua
      ...
      commonPrint.log('getFileResponseForUrlDirect error ${e.toString()}');
